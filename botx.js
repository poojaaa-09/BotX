...
class BOTX extends ActivityHandler {
    ...
    async sendWelcomeMessage(turnContext) {
        ...
        for (const idx in activity.membersAdded) {
            if (activity.membersAdded[idx].id !== activity.recipient.id) {
                const welcomeMessage = `Hi.I am BotX.Your personal interactive assistant. `;
    ...
    async sendSuggestedActions(turnContext) {
        var reply = MessageFactory.suggestedActions(['Book meet','Cancel meet','Know Us'],'How may I help you ?');
    ...
    switch(currentIntent)
    {
        ...
        case 'Book_meet':
        console.log("Inside Make Book meet case");
        ...
        case 'Cancel_meet':
            console.log("Inside Cancel meet Case");
            await this.conversationData.set(context,{endDialog: false});
